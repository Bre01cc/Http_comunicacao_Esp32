...
Como mencionado, há a comunicação entre dois ESP32: um responsável pela interação com a interface web e controle do LED, e outro atuando como sensor, captando as variações de temperatura e umidade do ambiente.

## Demonstração
Funcionamento do projeto em vídeo:
- [Vídeo](https://youtu.be/Z2VLlY1q83E?si=pq43Jj8zzDHtcWhg)
